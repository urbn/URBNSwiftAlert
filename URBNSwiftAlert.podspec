...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of URBNSwiftAlert.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Kevin Taniguchi/URBNSwiftAlert'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Kevin Taniguchi' => 'ktaniguchi@urbn.com' }
  s.source           = { :git => 'https://github.com/Kevin Taniguchi/URBNSwiftAlert.git', :tag => s.version.to_s }
